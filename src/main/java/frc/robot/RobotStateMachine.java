 ...
 * 
 * REBUILT Game Overview:
 * - Score Fuel (balls) into Hubs
 * - Hub Shift mechanic: Hubs alternate between ACTIVE and INACTIVE
 * - Climb the Tower with multiple levels (L1=15pts, L2, L3)
 * - Height restriction: Must be < 30 inches during climbing phases
 */
public class RobotStateMachine extends SubsystemBase {
    ...
    /**
     * CLIMB STATE - Tower climbing state machine
     * Climbing has height restrictions (must be < 30 inches at certain phases)
     */
    ...
    /**
     * GAME STATE - Robot strategy/behavior for REBUILT
     * Implements the Hub Shift Meta strategy
     */
    public enum GameState {
        ...
        public boolean isCollecting() {
            return this == COLLECTING_GROUND || this == AUTO_COLLECTING || 
                   this == INTAKE_ACQUIRING || this == SEEKING_FUEL || this == HOARDING;
        }
        
        public boolean isScoring() {
            return this == SCORING_HUB || this == FIRING_FUEL || 
                   this == AUTO_SCORING_PRELOAD || this == SCORING_FINAL;
        }
        
        public boolean isNavigating() {
            return this == APPROACHING_HUB || this == APPROACHING_CLIMB || 
                   this == AUTO_NAVIGATING || this == SEEKING_FUEL || this == REPOSITIONING;
        }
        
        public boolean isEndgame() {
            return this == APPROACHING_CLIMB || this == PREPARING_CLIMB || 
                   this == CLIMBING_L1 || this == CLIMBING_L2 || this == CLIMBING_L3 ||
                   this == CLIMBED_L1 || this == CLIMBED_L2 || this == CLIMBED_L3 ||
                   this == SCORING_FINAL;
        }
        ...
        public boolean isHubActive() {
            return this == SHIFT_ACTIVE || this == AIMING_AT_HUB || 
                   this == SHOOTER_SPINUP || this == FIRING_FUEL;
        }
        
        public boolean isHubInactive() {
            return this == SHIFT_INACTIVE || this == INTAKE_ACQUIRING || 
                   this == DEFENSE_BLOCKING || this == HOARDING || this == HIDING;
        }
     ...
     * Drivetrain mode is decoupled from game state for flexibility
     */
    ...
    public HubShiftState getHubShiftState() { return hubShiftState; }
    public ClimbState getClimbState() { return climbState; }
    ...
    public boolean isInState(FuelState state) { return fuelState == state; }
    public boolean isInState(HubShiftState state) { return hubShiftState == state; }
    public boolean isInState(ClimbState state) { return climbState == state; }
    
    // ===== FUEL MANAGEMENT =====
    // NOTE: No max capacity!
    public boolean hasFuel() { return fuelCount > 0; }
    public boolean isEmpty() { return fuelCount == 0; }
    
    /**
     * Check if ready to fire (aligned + RPM + has fuel)
     */
    public boolean isReadyToFire() { 
        return hasFuel() && isAlignedToTarget && isShooterAtRPM && 
               (hubShiftState == HubShiftState.MY_HUB_ACTIVE || hubShiftState == HubShiftState.TRANSITION);
    }
    ...
    public boolean isAlignedToTarget() { return isAlignedToTarget; }
    ...
    public boolean isShooterAtRPM() { return isShooterAtRPM; }
    ...
    public int getFuelScoredAuto() { return fuelScoredAuto; }
    public int getFuelScoredTeleop() { return fuelScoredTeleop; }
    public int getTotalFuelScored() { return fuelScoredAuto + fuelScoredTeleop; }

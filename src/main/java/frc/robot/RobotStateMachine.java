...
/**
 * MASTER ROBOT STATE MACHINE - FRC 2026 REBUILT This is the HIGHEST level state machine that controls the ENTIRE robot.
 * Every aspect of robot operation flows through this state machine.
 *
 * <p>REBUILT Game Overview: - Score Fuel (balls) into Hubs - Hub Shift mechanic: Hubs alternate between ACTIVE and
 * INACTIVE - Climb the Tower with multiple levels (L1=15pts, L2, L3) - Height restriction: Must be < 30 inches during
 * climbing phases
 */
public class RobotStateMachine extends SubsystemBase {
    ...
    /**
     * CLIMB STATE - Tower climbing state machine Climbing has height restrictions (must be < 30 inches at certain
     * phases)
     */
    ...
    public enum GameState {
        ...
        public boolean isScoring() {
            return this == SCORING_HUB || this == FIRING_FUEL || this == AUTO_SCORING_PRELOAD || this == SCORING_FINAL;
        }
        ...
        public boolean isHubActive() {
            return this == SHIFT_ACTIVE || this == AIMING_AT_HUB || this == SHOOTER_SPINUP || this == FIRING_FUEL;
        }
    ...
    public void updateAlliance() {
        if (DriverStation.getAlliance().isPresent()) {
            alliance = DriverStation.getAlliance().get() == Alliance.Red ? AllianceColor.RED : AllianceColor.BLUE;
        } else {

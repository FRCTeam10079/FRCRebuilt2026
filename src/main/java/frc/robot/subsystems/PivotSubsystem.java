  ...
  void configureMotors() {
    ...
    mm.withMotionMagicCruiseVelocity(
        ...
        .withMotionMagicAcceleration(
            RotationsPerSecondPerSecond.of(1)) // Take approximately 0.5 seconds to
        // reach max vel
    ...
    config.SoftwareLimitSwitch.ForwardSoftLimitThreshold =
        Constants.IntakeConstants.PIVOT_STOWED_POSITION; // Slightly
    // past
    // intake
    // position
    config.SoftwareLimitSwitch.ForwardSoftLimitEnable = true;
    config.SoftwareLimitSwitch.ReverseSoftLimitThreshold =
        Constants.IntakeConstants.PIVOT_INTAKE_POSITION; // Slightly
    // past
    // stowed

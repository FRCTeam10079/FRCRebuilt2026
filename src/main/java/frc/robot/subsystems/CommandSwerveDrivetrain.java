...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
     ...
     *
     * <p>Uses OpenLoopVoltage for more responsive driving feel during teleop (as opposed to Velocity mode which can
     * feel sluggish).
     */
    private final SwerveRequest.ApplyFieldSpeeds m_fieldCentricRequest =
            new SwerveRequest.ApplyFieldSpeeds().withDriveRequestType(SwerveModule.DriveRequestType.OpenLoopVoltage);

    /**
     * Calculate chassis speeds with skew compensation for smooth driving.
     *
     * <p>Skew compensation corrects for the drift that occurs when both translating and rotating simultaneously. The
     * robot's actual heading is predicted slightly ahead based on current rotational velocity.
     *
     ...
     *
     * <p>Features: - Deadband application to eliminate joystick drift - Squared angular input for finer low-speed
     * rotation control - Skew compensation for smooth combined translation/rotation - OpenLoopVoltage mode for
     * responsive feel - Runtime velocity coefficients for slow mode / scoring mode
     *

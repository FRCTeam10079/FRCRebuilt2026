...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
     ...
     * 
     * Uses OpenLoopVoltage for more responsive driving feel
     * during teleop (as opposed to Velocity mode which can feel sluggish).
     */
     ...
     * 
     * Skew compensation corrects for the drift that occurs
     * when both translating and rotating simultaneously. The robot's actual heading
     * is predicted slightly ahead based on current rotational velocity.
     * 
     ...
     * 
     * Features:
     * - Deadband application to eliminate joystick drift
     * - Squared angular input for finer low-speed rotation control
     * - Skew compensation for smooth combined translation/rotation
     * - OpenLoopVoltage mode for responsive feel
     * - Runtime velocity coefficients for slow mode / scoring mode
     * 
    ...
    /**
     * Set the translation velocity coefficient for teleop driving.
     * Use this for slow mode, scoring mode, etc.
     * 
    ...
    /**
     * Enable heading lock mode with a specific target heading.
     * In this mode, the robot will automatically rotate to face the target heading
     * while still allowing the driver to control translation.
     * 
     ...
     * controlled by the heading controller to maintain the locked heading.
     * This creates a "turret mode" where the robot faces a specific direction
     * regardless of how the driver is strafing.
     * 
     * @param xInput Raw X joystick input (-1 to 1)
     * @param yInput Raw Y joystick input (-1 to 1)
     * @param maxVelocity Maximum translation velocity (m/s)
     ...
     * automatically rotates to face the specified target heading.
     * 

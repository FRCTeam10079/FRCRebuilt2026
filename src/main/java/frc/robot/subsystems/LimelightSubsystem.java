...
/**
 * Subsystem for Limelight vision camera
 * Handles AprilTag detection and robot pose estimation
 * 
 * For REBUILT 2026 season - used for hub alignment
 */
public class LimelightSubsystem extends SubsystemBase {
    ...
    public LimelightSubsystem() {
        ...
        // Configure Limelight
        LimelightHelpers.setPipelineIndex(VisionConstants.LIMELIGHT_NAME, VisionConstants.PIPELINE_APRILTAG);
    ...
    /**
     * @return The robot pose on field from Blue alliance origin
     *         [X, Y, Z, Roll, Pitch, Yaw, Latency, Tag Count, Tag Span, Avg Tag Distance, Avg Tag Area]
     */
